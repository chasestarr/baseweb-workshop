...
const Sidebar = styled("div", props => {
  return {
    backgroundColor: props.$theme.colors.mono300,
    width: "300px",
    height: "95vh",
  };
});
...
const Body = styled("div", props => {
  return {
    marginTop: props.$theme.sizing.scale800,
    marginLeft: props.$theme.sizing.scale1200,
    marginRight: props.$theme.sizing.scale1200,
    width: "100%",
  };
});
